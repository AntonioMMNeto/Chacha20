...
MEM_0 := SistemaEmbarcadoChaChaVerilog_MemoriaPrograma
$(MEM_0)_NAME := MemoriaPrograma
...
$(MEM_0)_END := 0x000567ff
$(MEM_0)_SPAN := 0x00016800
$(MEM_0)_HIERARCHICAL_PATH := MemoriaPrograma
$(MEM_0)_WIDTH := 32
...
MemoriaPrograma: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
